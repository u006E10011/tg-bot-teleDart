...
### Фильтры чата
- `/fc <ключ>` - Создать фильтр чата (ответом на сообщение)
- `/fs` - Показать все фильтры текущего чата

### Личные фильтры
- `/mfc <ключ>` - Создать личный фильтр (ответом на сообщение)
- `/mf <ключ>` - Использовать личный фильтр
- `/mfs` - Показать все личные фильтры (только в личном чате с ботом)
...
1. **Фильтры чата** - создаются в конкретном чате и работают только в нём
   - Автоматически срабатывают при упоминании ключевого слова в сообщении
   - Создаются командой `/fc <ключ>` ответом на сообщение

2. **Личные фильтры** - создаются в любом чате и доступны везде
   - Можно создать в любом чате командой `/mfc <ключ>`
   - Вызываются только командой `/mf <ключ>`
   - Список можно посмотреть только в личном чате с ботом
